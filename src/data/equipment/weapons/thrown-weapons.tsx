...
const exObj: { [key: string]: Weapon } = {
  ...
  fragmentationGrenade: {
    ...
    isAdvancedItem: false,
    attackModes: [{
      tags: ['Short Range', 'Medium Range', 'Thrown', { tag: 'Area', value: 1 }, { tag: 'Scatter', value: 2 }],
      damage: {
  ...
  flashbangGrenade: {
    ...
    isAdvancedItem: false,
    attackModes: [{
      tags: ['Short Range', 'Medium Range', 'Thrown', { tag: 'Area', value: 2 }, { tag: 'Scatter', value: 3 }],
      damage: {
  ...
  incendiaryGrenade: {
    ...
    isAdvancedItem: true,
    attackModes: [{
      tags: ['Short Range', 'Medium Range', 'Thrown', { tag: 'Area', value: 1 }, { tag: 'Scatter', value: 1 }],
      damage: {
