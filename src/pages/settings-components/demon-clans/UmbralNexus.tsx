...
export default function UmbralNexus ({ hx }: Props) {
  return (
    <ColumnEntry title={{ hx: hx, text: "Umbral Nexus" }}>
      <p>The Umbral Nexus is composed of Voidyr-aligned demons that bear an unsettling resemblance to humans, save for a few grotesque distortions. Some have arms with extra joints, smiles that stretch unnaturally wide, or eyes that sprout in strange places.</p>
