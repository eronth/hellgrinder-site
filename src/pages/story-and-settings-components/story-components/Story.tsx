    ...
    <div className='col-handler'>
      ...
      <div>
        ...
        <p>
          ...
          to begin distribution of Safelight Shards to teh front lines. The Safelight Project was born.
        </p>
        <p>
