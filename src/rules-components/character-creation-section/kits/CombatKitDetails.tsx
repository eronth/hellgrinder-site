...
demonHunter.weapons[1].attackModes[0].damage.l.type = 'Nethercurrent';
demonHunter.weapons[1].attackModes[0].damage.m.type = 'Nethercurrent';
demonHunter.weapons[1].attackModes[0].damage.h.type = 'Nethercurrent';
demonHunter.weapons[1].attackModes[0].effects = [
...
warrior.weapons[0].attackModes[0].damage.l.type = 'Verdant';
warrior.weapons[0].attackModes[0].damage.m.type = 'Verdant';
warrior.weapons[0].attackModes[0].damage.h.type = 'Verdant';
warrior.weapons[0].attackModes[0].effects = [
  ...(sword.attackModes[0]?.effects ?? []),
  ''
];

const prototype: KitType = {
  name: 'Prototype',
...
export { sniper, grenadier, flamethrower, breachAndClear, soldier, demonHunter, perky, riot, helltouched, relicworker, warrior, prototype };