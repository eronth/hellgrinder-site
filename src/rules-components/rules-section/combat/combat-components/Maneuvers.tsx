  ...
  return (<>
    ...
    <ColumnEntry title={{ hx: 'h4', text: 'Move' }}>
      ...
      <ul>
        ...
        <li>Trudge - </li>
        <li>Step - </li>
        <li>Change Facing - Change what direction you're facing, to adjust your Front, Flanking, and Rear arcs. The first Change Facing you make on your turn is free, each after the first costs 1 Movement Point.</li>
