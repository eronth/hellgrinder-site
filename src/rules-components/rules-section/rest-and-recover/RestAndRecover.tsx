  ...
  return (<>
    ...
    <div className='col-handler'>
      ...
      <ColumnEntry title={{ hx: 'h3', text: 'Recovery Check' }}>
        <p>When you use a safelight object to recover, you roll a Recovery Skill Check. When you do, you almost always heal, but the amount differs based on your success.</p>
        <ul>
      ...
      <ColumnEntry title={{ hx: 'h3', text: 'Gaining Squad Memebers' }}>
